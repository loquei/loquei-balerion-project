...
public class RentListenersConfig {
    ...
    @Bean
    public RentCreatedNotificationListener rentCreatedNotificationListener() {
        return new RentCreatedNotificationListener(rentGateway, userGateway, itemGateway, emailGateway);
    }
