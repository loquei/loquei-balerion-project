...
public final class SendLessorRentRequestEmailHelper {

    private SendLessorRentRequestEmailHelper() {}
    ...
    private static String buildLessorEmailSubject() {
        return "Solicitação de locação recebida!";
    }
    ...
    private static String buildLessorEmailBody(final User lessor, final Item item, final Rent rent) {
        ...
        sb.append("Você recebeu uma solicitação de locação com os dados abaixo:\n");
