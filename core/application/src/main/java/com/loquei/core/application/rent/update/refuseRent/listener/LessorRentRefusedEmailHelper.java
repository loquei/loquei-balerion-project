...
public final class LessorRentRefusedEmailHelper {

    private LessorRentRefusedEmailHelper() {}
    ...
    private static String buildLessorEmailSubject() {
        return "Solicitação de locação recusada!";
    }
    ...
    private static String buildLessorEmailBody(final User lessor, final Item item, final Rent rent) {
        ...
        sb.append("Você recusou uma solicitação de locação!\n");
