...
import static com.loquei.core.application.rent.update.acceptRent.listener.LesseeRentAcceptedEmailHelper.buildLesseeEmail;
import static com.loquei.core.application.rent.update.acceptRent.listener.LessorRentAcceptedEmailHelper.buildLessorEmail;
import static java.util.Objects.requireNonNull;

public class RentAcceptedNotificationListener implements EventListener<RentAcceptedNotificationEvent> {
    ...
    public RentAcceptedNotificationListener(
    ...
    @Override
    public void onEvent(final RentAcceptedNotificationEvent event) {
